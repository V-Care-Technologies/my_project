   ...
   <div class="row">
      ...
      <div class="col-xl-6 col-md-6 col-12 right_box">
        <a href="javascript:void(0)" class="main-btn export_btn btn-excel">Export <img src="{{asset('public/admin/images/download.svg')}}" class="ps-2"></a>
         <a href="{{route('admin.manage.category')}}" class="main-btn bordered_btn export_btn"><img src="{{asset('public/admin/images/plus.svg')}}" class="pe-2">Add</a>
      </div>
   </div> 
            ...
            <tbody>
               ...
               @foreach($category as $list)
                  <tr>
                     ...
                     <td><span class="name">{{$list->category_name}}</span></td> 
                     <td><span class="name">{{$list->category_slug}}</span></td>
                    <td><div class="sqr_img_box">@if($list->category_image)<img src="{{asset('storage/app/public/media/category/'.$list->category_image)}}"/>@endif</div></td> 
                      <td class="small_td">
                         <span class="name small_name">
                           <a href="{{url('admin/category/manage-category/')}}/{{$list->id}}"><img src="{{asset('public/admin/images/edit_icon.svg')}}" class="pe-2"></a>
