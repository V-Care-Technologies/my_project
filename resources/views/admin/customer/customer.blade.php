    ...
    <div class="inner-main-content">
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6 col-12 right_box">
                ...
                <a href="{{ route('admin.manage.customer') }}" class="main-btn bordered_btn export_btn"><img
                            ...
                            <tr>
                                ...
                                <td class="small_td">
                                    <span class="name small_name">
                                        ...
                                        <a href="{{ url('admin/customer/manage-customer/') }}/{{ $list->id }}"><img
