    ...
    <div class="inner-main-content">
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6 col-12 right_box">
                ...
                <a href="{{ route('admin.manage.video') }}" class="main-btn bordered_btn export_btn"><img
                    ...
                    <tbody>
                        ...
                        @foreach ($video as $list)
                            <tr>
                                ...
                                <td><span class="name">{{ $list->video_url }}</span></td>

                                <td class="small_td">
                                    <span class="name small_name">
                                        <a href="{{ url('admin/video/manage-video/') }}/{{ $list->id }}"><img
