                ...
                <table class="table" id="example">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $list)
                            @php
                                $getUser = App\Models\AssignTeam::rightJoin(
                                    'users',
                                    'users.id',
                                    '=',
                                    'assign_team.user_id',
                                )
                                    ->select('assign_team.*', 'users.name as user_name')
                                    ->where('assign_team.project_id', $list->id)
                                    ->get();
                            @endphp
                            <tr>
                                ...
                                <td class="small_td">
                                    <span class="name small_name">
                                        {{-- <a href="{{ url('admin/customer/show/') }}/{{ $list->id }}">View</a> --}}
                                        <a href="{{ url('admin/project/manage-project/') }}/{{ $list->id }}"><img
