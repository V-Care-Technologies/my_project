    ...
    <div class="inner-main-content">
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6 col-12 right_box">
                ...
                <a href="{{ route('admin.manage-home-banner') }}" class="main-btn bordered_btn export_btn"><img
                ...
                <table class="table" id="example">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Mobile Banner Image</th>
                            <th scope="col">Web Banner Image</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($banner as $list)
                            <tr>
                                ...
                                <td class="banner_img_box"><img
                                        src="{{ asset('storage/app/public/media/banner/' . $list->image) }}" /></td>
                                <td class="banner_img_box"><img
                                        src="{{ asset('storage/app/public/media/banner/' . $list->image1) }}" /></td>
                                <td>
                                    @if ($list->status == '0')
                                        Active
                                    @else
                                ...
                                <td>
                                    <span class="name small_name">
                                        <a href="{{ url('admin/home-banner/manage-home-banner/') }}/{{ $list->id }}"><img
                                                src="{{ asset('public/admin/images/edit_icon.svg') }}" class="pe-2"></a>
                                        <a href="javascript:void(0)" class="del_popup2" data-id="{{ $list->id }}"><img
