   ...
   <div class="row">
      ...
      <div class="col-xl-6 col-md-6 col-12 right_box">
        <a href="javascript:void(0)" class="main-btn export_btn btn-excel">Export <img src="{{asset('public/admin/images/download.svg')}}" class="ps-2"></a>
         <a href="{{route('admin.manage.partners')}}" class="main-btn bordered_btn export_btn"><img src="{{asset('public/admin/images/plus.svg')}}" class="pe-2">Add</a>
      </div>
   </div> 
                  ...
                  <tr>
                     ...
                     <td><span class="name">
                        <div class="sqr_img_box">
                            @if($list->image!='')
                                <img  src="{{asset('storage/app/public/media/partners/'.$list->image)}}"/>
                            @endif
                        </div>
                     </span></td>
                      ...
                      <td class="small_td">
                         <span class="name small_name">
                           <a href="{{url('admin/partners/manage-partners/')}}/{{$list->id}}"><img src="{{asset('public/admin/images/edit_icon.svg')}}" class="pe-2"></a>
