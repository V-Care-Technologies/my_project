        ...
        <table class="table order_detail" style="border-collapse: collapse;width: 100%;max-width: 100%;margin-bottom:50px;background-color: transparent;">
            ...
            <tbody>
                 ...
                 <tr>
                    ...
                    <td style="border:2px solid #c9c9c9;padding:8px;text-align:right">{{number_format($list->price, 2)}}</td>
                    <td style="border:2px solid #c9c9c9;padding:8px;text-align:center">{{$list->qty}}</td>
                    <td style="border:2px solid #c9c9c9;padding:8px;text-align:right">{{number_format(($list->price*$list->qty), 2)}}</td>
                  ...
                  <tr>
                      ...
                      <td style="border:2px solid #c9c9c9;padding:8px;text-align:right">{{number_format($totalAmt, 2)}}</td>
                    </tr>
                 @endforeach
                 <!--<tr>-->
                 <!--   <td colspan="5">&nbsp;</td>-->
